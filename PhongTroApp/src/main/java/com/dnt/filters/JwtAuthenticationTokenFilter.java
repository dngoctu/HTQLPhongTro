         ...
         try {
             if (jwtService.validateTokenLogin(authToken)) {
                 ...
                 if (taiKhoan != null) {
                     ...
                     authorities.add(new SimpleGrantedAuthority(taiKhoan.getVaiTro()));
                     
                     UserDetails userDetail = new org.springframework.security.core.userdetails.User(username, taiKhoan.getPassword(), enabled, accountNonExpired,
